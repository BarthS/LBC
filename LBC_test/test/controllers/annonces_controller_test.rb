...
class AnnoncesControllerTest < ActionController::TestCase
  ...
  test "should create annonce" do
    assert_difference('Annonce.count') do
      post :create, annonce: { description: @annonce.description, image: @annonce.image, numero: @annonce.numero, titre: @annonce.titre, user: @annonce.user }
    end
  ...
  test "should update annonce" do
    patch :update, id: @annonce, annonce: { description: @annonce.description, image: @annonce.image, numero: @annonce.numero, titre: @annonce.titre, user: @annonce.user }
    assert_redirected_to annonce_path(assigns(:annonce))
  end
